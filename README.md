...
- **Source & issues (this fork):** [github.com/Blackphi6/video-speed-controller-plus](https://github.com/Blackphi6/video-speed-controller-plus)
- **Security:** [SECURITY.md](SECURITY.md)
- **CI:** Push/PR to `main` runs syntax checks, JSON validation, and `npm run verify` (manifest ↔ `REPO_HOME_URL`, required locale keys).
