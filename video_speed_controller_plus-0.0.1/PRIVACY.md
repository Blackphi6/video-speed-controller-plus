...
For **security vulnerabilities**, do not use a public issue — follow **[SECURITY.md](https://github.com/Blackphi6/video-speed-controller-plus/blob/main/SECURITY.md)** in this repository instead.
